	...
	public Seller fidById(Integer id) {
		...
		try {
			...
			if(rs.next()) {
				...
				// Seller e Department e retorna um Seller. Porém, primeiro verifica se o resultSet não
			...
			// a conexão não é fechada, pois pode ser que o usuário queira fazer uma outra opeação. 
		}
	}
